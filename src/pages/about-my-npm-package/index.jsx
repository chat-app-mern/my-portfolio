            ...
            <div className="container sm">
                ...
                <section className="section-padding">
                    ...
                    <p className="text-center text-grey pt-4 text-xl font-medium">
                        VideoTrimmer is a lightweight and easy-to-use tool that
                        makes video editing simple. With it, you can upload your
                        videos, add trim markers, preview specific segments, and
                        download the final trimmed clips—all directly in your
                        browser. Built with ffmpeg.wasm and FilePond, it gives
                        you a smooth editing experience without needing any
                        extra software.
                    </p>
                    <p className="text-center text-grey pt-4 text-xl font-medium">
                        Editing videos shouldn’t be complicated. VideoTrimmer
                        lets you drag and drop videos, set exact start and end
                        points using trim markers, preview your selections, and
                        adjust or remove markers anytime. You can even discard
                        unwanted clips, making sure your final video is exactly
                        how you want it.
                    </p>
                    <p className="text-center text-grey pt-4 text-xl font-medium">
                        VideoTrimmer is packed with handy features: return to
                        edit your clips, preview segments before cutting,
                        download trimmed videos instantly, and manage markers
                        with ease. It uses ffmpeg.wasm for fast client-side
                        trimming and FilePond for smooth drag-and-drop uploads
                        with live previews, so editing your videos becomes
                        quick, fun, and hassle-free.
                    </p>
                </section>
